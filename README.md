...
- 삼성 청년 SW·AI 아카데미(SSAFY) 14th 코딩 트랙 JAVA 전공 (구미캠퍼스)
...
- 편리한 기능을 제공하는 웹 기반의 터미널 서비스 (Husk)
- 초보 개발자들을 위한 LLM 기반 프로젝트 관리 플랫폼 ProjecTree
- 알고리즘 문제의 반례를 찾아주는 서비스 WAy Out
- 러닝 입문자와 초보 러너들을 위한 러닝 코스 추천 서비스 With Run
- AI 기반 사내 업무 관리 시스템(삼성 청년 SW·AI 아카데미 기업 연계 프로젝트 - 기업명:IBank) - ACODIAN
